...
def benchmark_phase1_performance():
    """Benchmark Phase 1 enhanced performance"""
    from poker_bot.core.trainer import benchmark_definitive_hybrid_performance
    
    logger.info("🔥 Benchmarking Phase 1 Enhanced Performance")
    
    # Enhanced config for benchmarking
    ...
    for i in range(iterations):
        ...
        logger.info(f"   Phase 1 Iteration {i+1}: {games_per_second:,.1f} games/sec")
    ...
    logger.info(f"   Target: {'✅' if avg_games_per_second > 800 else '❌'}")
